const words = {
    ...
    Personagem: ['pernalonga', 'patolino', 'piu-piu', 'frajola', 'tom', 'jerry', 'shrek', "fiona", "encantado", 'pica-pau', 'zeca urubu', 'leoncio', 'ze colmeia', 'catatau', 'bob esponja', 'patrick', 'lula molusco', 'sandy bochechas', 'sr sirigueijo', 'plankton', 'sra puff', 'gary', 'nemo', 'dory', 'aladdin', 'abu', 'jasmin', 'jafar', 'cinderela', 'braca de neve', 'pinoquio', 'pluto', 'pato donald', 'mickey', 'pateta', 'kronk', 'cruella', 'woody', 'buzz lightyear', 'pooh'],
